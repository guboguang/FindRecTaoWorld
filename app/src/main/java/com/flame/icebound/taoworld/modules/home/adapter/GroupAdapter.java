...
public class GroupAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){  
            ...
            convertView = mInflater.inflate(R.layout.item_image_dir_view, null);
            viewHolder.mImageView = (MyImageView) convertView.findViewById(R.id.iv_icon);
            viewHolder.mTextViewTitle = (TextView) convertView.findViewById(R.id.tv_dir_name);
            viewHolder.mTextViewCounts = (TextView) convertView.findViewById(R.id.tv_file_number);
